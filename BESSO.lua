...
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/DEVBESSO)}\n📛¦["..BESSO_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤¦ بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'DEVBESSO')..') \n🔐¦ تـم قفـل الدردشه ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤¦ بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'DEVBESSO')..') \n🔐¦ تـم قفـل التاك بالكتم ')  
end,nil)   
...
local UserName = (b.username_ or "besso500k")
...
usertext = '\n👤¦ المستخدم » ['..result.title_..'](t.me/'..(username or 'DEVBESSO')..')'
statusk  = '\n📫¦ تم طرده من هنا'
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
 usertext = '\n👤¦ المستخدم » ['..data.first_name_..'](t.me/'..(data.username_ or 'DEVBESSO')..')'
 statusk  = '\n📫¦ تم طرده من هنا'
send(msg.chat_id_, msg.id_, usertext..statusk)
else
 usertext = '\n👤¦ المستخدم » '..userid..''
...
if text and text:match("^غادر (%d+)$") and Mod(msg) then
local userid = text:match("^غادر (%d+)$") 
send(msg.chat_id_, msg.id_,'\n🩸┇ المطورين فقط')
else 
local leavegp = function(extra, result)
if result.id_ then
send(msg.chat_id_, msg.id_,'\n🦠┇المجموعه ⌯» (" .. result.title_ ..")\n🗽┇تم المغادره بئمرمن المطور')
end
...
if blakrt == 'مميز 🕵🏻‍♀️' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤¦ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'DEVBESSO')..')'..'\n📬¦ تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
