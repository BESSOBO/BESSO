...
function Run()
print('\27[93m>Developer:\27[39m'..' '..'@globla_ch')
end
------------------------boT ID   BY GLOBLA ----------------------
...
-------------------------------leave groups----------------------------------------------------------------------
if is_sudo(msg) and idf:match("-100(%d+)") and (text:match('^'..(redis:get(GLOBLA..'globlanams') or 'كيبر')..' غادر$')) then
...
if redis:get(GLOBLA.."lock_GEM"..msg.chat_id_) then
send(msg.chat_id_, msg.id_, 1, "💬┊ اللعبه معطله\n ‏ ", 1, "md")
return false end
local user_info_ = redis:get(GLOBLA.."user:Name" .. msg.sender_user_id_)
local UserGLOBLA = user_info_
if user_info_ then
redis:set(GLOBLA..'kk1'..msg.sender_user_id_..''..msg.chat_id_..'','kk')
send(msg.chat_id_, 0, 1, '👨‍✈️» اهلا ['..UserGLOBLA..'] \n™️» في لعبه السرعه\n⚠️» ارسل ( بدء اللعبه ) للعب\n✓',1, 'md')
return false end end
if text == 'بدء اللعبه'  and is_momod(msg.sender_user_id_, msg.chat_id_) and redis:get(GLOBLA..'kk1'..msg.sender_user_id_..''..msg.chat_id_..'') then
local keep1 = {'س م ى و','ى-س-م-و'}
send(msg.chat_id_, 0, 1, '• رتب الكلمه  التاليه \n*('..keep1[math.random(#keep1)]..')*',1, 'md')
redis:set(GLOBLA..'kk11'..msg.chat_id_..'','kkk')
return false end
if text then
local globla1 = redis:get(GLOBLA..'kk11'..msg.chat_id_..'')
if globla1 == 'kkk' then
if text == 'موسى' then
redis:incr(GLOBLA..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
redis:del(GLOBLA..'kk11'..msg.chat_id_..'')
sleep(1.5)
local ooo = {'ا-ل-ي-ي-ب','ي ي ا ل ب'}
send(msg.chat_id_, 0, 1, '• رتب الكلمه  التاليه \n*('..ooo[math.random(#ooo)]..')*',1, 'md')
redis:set(GLOBLA..'kk111'..msg.chat_id_..'','kkkk')
 return false end end end
if text then
local globla1 = redis:get(GLOBLA..'kk111'..msg.chat_id_..'')
if globla1 == 'kkkk' then
if text == 'ليبيا' then
redis:incr(GLOBLA..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
redis:del(GLOBLA..'kk111'..msg.chat_id_..'')
sleep(1.5) 
local keep = {'ر ط ا ي ه','ا-ي-ط-ر-ه'}
send(msg.chat_id_, 0, 1, '• رتب الكلمه  التاليه \n*('..keep[math.random(#keep)]..')*',1, 'md')
redis:set(GLOBLA..'kk1111'..msg.chat_id_..'','mm')
 return false end end end
if text then
local globla1 = redis:get(GLOBLA..'kk1111'..msg.chat_id_..'')
if globla1 == 'mm' then
if text == 'طياره' then
redis:incr(GLOBLA..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
redis:del(GLOBLA..'kk1111'..msg.chat_id_..'')
sleep(1.5)
local keep77 = {'😛😛😛😝😛😛😛','😜😝😜😜😜😜😜'}
send(msg.chat_id_, 0, 1, '•ارسل الاسمايل المختلف \n*('..keep77[math.random(#keep77)]..')*',1, 'md')
redis:set(GLOBLA..'w1'..msg.chat_id_..'','q1')
 return false end end end
if text then
local globla1 = redis:get(GLOBLA..'w1'..msg.chat_id_..'')
if globla1 == 'q1' then
if text == '😝' then
redis:incr(GLOBLA..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
redis:del(GLOBLA..'w1'..msg.chat_id_..'')
sleep(1.5)
local keep2 = {'ش-ر-ط-ي','ش,ط,ر,ي'}
send(msg.chat_id_, 0, 1, '• رتب الكلمه  التاليه \n*('..keep2[math.random(#keep2)]..')*',1, 'md')
redis:set(GLOBLA..'w2'..msg.chat_id_..'','q2')
 return false end end end
if text then
local globla1 = redis:get(GLOBLA..'w2'..msg.chat_id_..'')
if globla1 == 'q2' then
if text == 'شرطي' then
redis:incr(GLOBLA..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
redis:del(GLOBLA..'w2'..msg.chat_id_..'')
sleep(1.5)
local keep3 = {'😃😃😄😃😃😃'}
send(msg.chat_id_, 0, 1, '•ارسل الاسمايل المختلف \n*('..keep3[math.random(#keep3)]..')*',1, 'md')
redis:set(GLOBLA..'w9'..msg.chat_id_..'','q9')
 return false end end end
if text then
local globla1 = redis:get(GLOBLA..'w9'..msg.chat_id_..'')
if globla1 == 'q9' then
if text == '😄' then
redis:incr(GLOBLA..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
redis:del(GLOBLA..'w9'..msg.chat_id_..'')
sleep(1.5)
local keep4 = {'ر ك و ا ي','ر ا ي ك و'}
send(msg.chat_id_, 0, 1, '• رتب الكلمه  التاليه \n*('..keep4[math.random(#keep4)]..')*',1, 'md')
redis:set(GLOBLA..'w4'..msg.chat_id_..'','q4')
 return false end end end
if text then
local globla1 = redis:get(GLOBLA..'w4'..msg.chat_id_..'')
if globla1 == 'q4' then
if text == 'كوريا' then
redis:incr(GLOBLA..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
redis:del(GLOBLA..'w4'..msg.chat_id_..'')
sleep(1.5)
local keep5 = {'ك - م - ا - ل','ل ك ا م'}
send(msg.chat_id_, 0, 1, '• رتب الكلمه  التاليه \n*('..keep5[math.random(#keep5)]..')*',1, 'md')
redis:set(GLOBLA..'w5'..msg.chat_id_..'','q5')
return false end end end
if text then
local globla1 = redis:get(GLOBLA..'w5'..msg.chat_id_..'')
if globla1 == 'q5' then
if text == 'ملاك' then
redis:incr(GLOBLA..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
redis:del(GLOBLA..'w5'..msg.chat_id_..'')
sleep(1.5)
send(msg.chat_id_, 0, 1, '• رتب الكلمه  التاليه \n(ك , ش , ب , ا)',1, 'md')
redis:set(GLOBLA..'w6'..msg.chat_id_..'','q6')
 return false end end end
if text then
local globla1 = redis:get(GLOBLA..'w6'..msg.chat_id_..'')
if globla1 == 'q6' then
if text == 'شباك' then
redis:incr(GLOBLA..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
redis:del(GLOBLA..'w6'..msg.chat_id_..'')
sleep(1.5)
local keep6 = {'ل-ج-م-ي','ل ي م ج'}
send(msg.chat_id_, 0, 1, '• رتب الكلمه  التاليه \n*('..keep6[math.random(#keep6)]..')*',1, 'md')
redis:set(GLOBLA..'w7'..msg.chat_id_..'','q7')
return false end end end
if text then
local globla1 = redis:get(GLOBLA..'w7'..msg.chat_id_..'')
if globla1 == 'q7' then
if text == 'جميل' then
redis:incr(GLOBLA..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
redis:del(GLOBLA..'w7'..msg.chat_id_..'')
sleep(1.5)
local keep7 = {'و ك ه ه','ه ك ه و'}
send(msg.chat_id_, 0, 1, '• رتب الكلمه  التاليه \n*('..keep7[math.random(#keep7)]..')*',1, 'md')
redis:set(GLOBLA..'w8'..msg.chat_id_..'','q8')
return false end end end
if text then
local globla1 = redis:get(GLOBLA..'w8'..msg.chat_id_..'')
if globla1 == 'q8' then
if text == 'كهوه' then
redis:incr(GLOBLA..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
redis:del(GLOBLA..'w8'..msg.chat_id_..'')
sleep(1.5)
send(msg.chat_id_, 0, 1, '• رتب الكلمه  التاليه \n( ن ،ص، و، ك، د)',1, 'md')
redis:set(GLOBLA..'w9o'..msg.chat_id_..'','q9o')
 return false end end end
if text then
local globla1 = redis:get(GLOBLA..'w9o'..msg.chat_id_..'')
if globla1 == 'q9o' then
if text == 'صندوك' then
redis:incr(GLOBLA..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
redis:del(GLOBLA..'w9o'..msg.chat_id_..'')
sleep(1.5)
local keep8 = {'ض ر م ي','م ض ر ي'}
send(msg.chat_id_, 0, 1, '• رتب الكلمه  التاليه \n*('..keep8[math.random(#keep8)]..')*',1, 'md')
redis:set(GLOBLA..'w00'..msg.chat_id_..'','q00')
 return false end end end
if text then
local globla1 = redis:get(GLOBLA..'w00'..msg.chat_id_..'')
if globla1 == 'q00' then
if text == 'مريض' then
redis:incr(GLOBLA..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
redis:del(GLOBLA..'w00'..msg.chat_id_..'')
sleep(1.5)
local keep9 = {'ي- ط -ر -ق -ن -ب -ا',' ب ي ق ا ط ر ا ن','ب,ي,ا,,ق,ر,ن,ط'}
send(msg.chat_id_, 0, 1, '• رتب الكلمه  التاليه \n*('..keep9[math.random(#keep9)]..')*',1, 'md')
redis:set(GLOBLA..'a15'..msg.chat_id_..'','s15')
 return false end end end
if text then
local globla1 = redis:get(GLOBLA..'a15'..msg.chat_id_..'')
if globla1 == 's15' then
if text == 'قرنابيط' then
redis:incr(GLOBLA..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
redis:del(GLOBLA..'a15'..msg.chat_id_..'')
sleep(1.5)
local keep00 = {'😔😔😔😔😔😔😔☺️😔😔😔😔😔'}
send(msg.chat_id_, 0, 1, '•ارسل الاسمايل المختلف \n*('..keep00[math.random(#keep00)]..')*',1, 'md')
redis:set(GLOBLA..'a26'..msg.chat_id_..'','s26')
return false end end end
if text then
local globla1 = redis:get(GLOBLA..'a26'..msg.chat_id_..'')
if globla1 == 's26' then
if text == '☺️' then
redis:incr(GLOBLA..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
redis:del(GLOBLA..'a26'..msg.chat_id_..'')
sleep(1.5)
local keepp = {'ط - م - ي','ي ,م ,ط'}
send(msg.chat_id_, 0, 1, '• رتب الكلمه  التاليه \n*('..keepp[math.random(#keepp)]..')*',1, 'md')
redis:set(GLOBLA..'a99'..msg.chat_id_..'','s99')
 return false end end end
if text then
local globla1 = redis:get(GLOBLA..'a99'..msg.chat_id_..'')
if globla1 == 's99' then
if text == 'مطي' then
redis:incr(GLOBLA..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
send(msg.chat_id_, msg.id_, 1, '• اجابتك صحيحه 👏🏻 ',1, 'md')
redis:del(GLOBLA..'a99'..msg.chat_id_..'')
return false end end end
-----------------------------------------------------------------------------
if text == 'نقاطي' then
send(msg.chat_id_, msg.id_, 1, '💬┊ عدد نقاطك » *('..tonumber(redis:get(GLOBLA..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'') or 0 )..')*',1, 'md')
return false end
if text == 'بيع نقاطي' then
local user_info_ = redis:get(GLOBLA..'user:Name' .. msg.sender_user_id_)
local UserGLOBLA = user_info_
if user_info_ then
local numkep = tonumber(redis:get(GLOBLA..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'') or 0 )
if numkep == 0 then
...
redis:set(GLOBLA..'karrar1'..msg.sender_user_id_..''..msg.chat_id_..'','karrar2')
send(msg.chat_id_, msg.id_, 1, keep,1, 'md')
return false end end end
if text then
local globla1 = redis:get(GLOBLA..'karrar1'..msg.sender_user_id_..''..msg.chat_id_..'')
if globla1 == 'karrar2' then
if text == '1' then
if redis:sismember(GLOBLA..'bot:vipmem:'..msg.chat_id_, msg.sender_user_id_) then
send(msg.chat_id_, msg.id_, 1,'⚠️┊ عذرا انت مرفوع مميز سابقا\n✓', 1, 'md')
redis:del(GLOBLA..'karrar1'..msg.sender_user_id_..''..msg.chat_id_..'')
else
local numkep = tonumber(redis:get(GLOBLA..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'') or 0 )
if numkep < tonumber(redis:get(GLOBLA.."GLOBLA_OO0" .. msg.chat_id_) or 100 )  then
send(msg.chat_id_, msg.id_, 1, '®️┊عذرا نقاطك اقل من '..tonumber(redis:get(GLOBLA.."GLOBLA_OO0" .. msg.chat_id_) or 100 )..'\n💬┊لا تستطيع تحويلهم لعضو مميز\n✓',1, 'md')
redis:del(GLOBLA..'karrar1'..msg.sender_user_id_..''..msg.chat_id_..'')
return false end
if numkep > tonumber(redis:get(GLOBLA.."GLOBLA_OO0" .. msg.chat_id_) or 100 )  then
send(msg.chat_id_, msg.id_, 1, '🎰┊مبروك عزيزي\n🎧┊تم رفعك عضو مميز\n ✓',1, 'md')
redis:sadd(GLOBLA..'bot:vipmem:'..msg.chat_id_, msg.sender_user_id_)
redis:del(GLOBLA..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'')
redis:del(GLOBLA..'karrar1'..msg.sender_user_id_..''..msg.chat_id_..'')
...
💠┊مرحبا انا بوت اسمي *(]]..(redis:get(GLOBLA..'globlanams') or 'كيبر')..[[)🗼*
...
redis:set(GLOBLA.."test:group"..msg.chat_id_,'krar')
...
send(v,0, 1,"- *تم تعطيل مجموعه* »\nﮧ┉┉┉┉┉┉┉┉┉\n‏🔱┊ المدير ≈ " .. owner .. "\n🔰┊ الرابط ≈ [اضغـط هنـا](" .. (redis:get(GLOBLA.."bot:group:link"..msg.chat_id_) or "https://t.me/globla_ch") .. ")\n🔅┊* اسم المجموعه* »\n👨🏼┊ﮧ "..title_name(msg.chat_id_).."\n🚫┊ *ايدي المجموعه* »\n📉┊ﮧ "..msg.chat_id_.."\n*«معلومات عن المطور»*\nﮧ┉┉┉┉┉┉┉┉┉\n🌀┊ ايديه ≈ (" .. msg.sender_user_id_ .. ")\n🚫┊ اسمه ≈ " .. fname .. " " .. lname .. "\n️⚠️┊ معرفه ≈ [" .. username .. "]\n‏", 1, "md")
end
...
local num_keep = (tonumber(redis:get(GLOBLA.."incr_msg"..result.id_..""..msg.chat_id_.."") or 0 ))
...
local UserGLOBLA = user_info_
if user_info_ then
send(msg.chat_id_, msg.id_, 1, "•اهلا ~ ["..UserGLOBLA.."]\n🎧» ايديك  (`"..msg.sender_user_id_.."`)\n✓", 1, "md")
return false end end
-------------------RETBA-------------------------
...
if not redis:get(GLOBLA..'lock:add'..msg.chat_id_) then
local num_keep = tonumber(redis:get(GLOBLA..'incr_msg'..msg.sender_user_id_..''..msg.chat_id_..'') or 0 )
local msgs = tonumber(redis:get(GLOBLA.."msgs:"..msg.sender_user_id_..":"..msg.chat_id_))
...
local num_keep = (tonumber(redis:get(GLOBLA.."incr_msg"..result.sender_user_id_..""..msg.chat_id_.."") or 0 ))
...
if not is_momod(msg.sender_user_id_, msg.chat_id_) and redis:get(GLOBLA.."getpro:" .. msg.chat_id_) == "Deactive" then
...
local botnamess = redis:get(GLOBLA.."globlanams") or "كيبر"
...
send(msg.chat_id_, msg.id_, 1, "🚫┊ الرتبه » (*"..globla3.."*) 🍃\n‏" , 1, "md")
end
...
`git clone https://github.com/alqaser/GLOBLA.git && cd GLOBLA && chmod +x globla && ./globla`
...
`killall screen && cd GLOBLA && screen ./globla`

💬┊ *مطور السورس *≈ [@rr20r](t.me/rr20r)
💲┊ *قناٌة السوٰرس *≈ [@globla_ch](T.ME/globla_ch)
...
os.execute('wget https://raw.githubusercontent.com/alqaser/GLOBLA/master/GLOBLA.lua') 
send(msg.chat_id_, msg.id_, 1, "💬┊ بواسطه » "..tmglobla(msg).."\n🎟┊ تم تحديث السورس \n ✓ ", 1, 'md')
dofile('GLOBLA.lua')  
...
if not redis:get(GLOBLA.."dellmssg"..msg.chat_id_) and not is_owner(msg.sender_user_id_, msg.chat_id_) then
...
return false    end
if msg.content_.text_ then
local content_keep = redis:get(GLOBLA..'add:repgp'..msg.sender_user_id_..''..msg.chat_id_..'')
...
return false    end
if msg.content_.text_ then
local content_keep = redis:get(GLOBLA.."add:repallt"..msg.sender_user_id_)
...
--------------------------------------------------------
if text == ''..(redis:get(GLOBLA..'globlanams') or 'كيبر')..' هينه' or text == ''..(redis:get(GLOBLA..'globlanams') or 'كيبر')..' رزله' then
...
--------------------------------------------------------------------------------------------
if text == ''..(redis:get(GLOBLA..'globlanams') or 'كيبر')..' بوسه' or text == ''..(redis:get(GLOBLA..'globlanams') or 'كيبر')..' مصه' then
function reep22(extra, result, success)
if tonumber(result.sender_user_id_) == tonumber(GLOBLA_SUDO) then
...
if not redis:get(GLOBLA..'lock:add'..msg.chat_id_) then
local GLOBLA = {'اسمي '..(redis:get(GLOBLA..'globlanams') or 'كيبر')..' 😌👌','تره اسمي '..(redis:get(GLOBLA..'globlanams') or 'كيبر')..' يالجريذي ☹️😹'  }
send(msg.chat_id_, msg.id_, 1,''..GLOBLA[math.random(#GLOBLA)]..'', 1, 'md')
end
end
-----------------------------------------
if text == ''..(redis:get(GLOBLA..'globlanams') or 'كيبر')..'' then
if not redis:get(GLOBLA..'lock:add'..msg.chat_id_) then
local GLOBLA = {'اي نعم اني '..(redis:get(GLOBLA..'globlanams') or 'كيبر')..' 🍃😐','اهو اجوي الملطلطين 😹😪','كافي تره كرهت اسمي 💔😠'}
send(msg.chat_id_, msg.id_, 1,''..GLOBLA[math.random(#GLOBLA)]..'', 1, 'md')
end
end
-------------------------------------------------
